...
export class ParentComponent {
  ...
  hobbies = [ new Hobby('movies', new Date(1999, 11, 13)), new Hobby('football', new Date(2012, 7, 15)),
    new Hobby('art', new Date(1993, 5, 3)), new Hobby('animals', new Date(2022, 6, 12))];
